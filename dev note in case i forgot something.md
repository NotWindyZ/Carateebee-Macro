...
```bash
pyinstaller --name="CoteabMacro" --noconsole --onefile --noupx --icon="lib/official_release.ico" --add-data "lib;lib" --add-data "venv_build\Lib\site-packages\autoit\lib\AutoItX3_x64.dll;autoit\lib" --collect-all webview --collect-all discord main.py
```
