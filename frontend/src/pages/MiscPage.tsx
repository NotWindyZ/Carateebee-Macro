        ...
        <>
            ...
            <div className="card">
                ...
                {(config.biome_randomizer || config.strange_controller) && (
                    <div style={{ marginTop: "12px", marginBottom: "16px", padding: "10px", background: "var(--bg-input)", borderRadius: "6px", border: "1px solid var(--border)" }}>
                        <label style={{ marginBottom: "8px", display: "block", fontFamily: 'inherit', textTransform: "uppercase", fontSize: "11px", letterSpacing: "0.05em", color: "var(--text-secondary)" }}>
                                ...
                                return (
                                    <button
                                        ...
                                        style={{
                                            ...
                                            borderLeft: isSelected ? `4px solid ${color}` : `1px solid rgba(${r},${g},${b},0.15)`,
                                            background: isSelected ? `rgba(${r},${g},${b},0.15)` : "var(--bg-card)",
                        ...
                        <span style={{ color: "var(--text-muted)", fontSize: "10px", display: "block", marginTop: "8px", fontFamily: 'inherit', letterSpacing: "0.02em" }}>
