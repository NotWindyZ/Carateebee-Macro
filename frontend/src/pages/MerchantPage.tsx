                ...
                {config.enable_jester_exchange && (
                    <div style={{ marginTop: "15px" }}>
                        <div
                            ...
                            style={{ cursor: "pointer", userSelect: "none", padding: "10px", background: "rgba(0,0,0,0.1)", borderRadius: "6px", color: "var(--text-primary)" }}
                            title="Click to toggle"
                        >
                            <div style={{ flexGrow: 1 }}>
                                <h4 style={{ color: "var(--text-primary)" }}>Select Items to Exchange</h4>
                            </div>
